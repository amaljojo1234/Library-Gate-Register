<?php
 function fetch_data()
 {
      ...
      $dept=$row['Department'];
      $sql="SELECT * FROM user where Department='$dept' and role='student'";
      $result=mysqli_query($conn,$sql);
 ...
 if(isset($_POST["create_pdf"]))
 {
      ...
      $obj_pdf->SetTitle("Currently_Present_detail");
      ...
      $content .= '
      <h3 align="center"><BR>
Library Currently Present Log<br><br><br><br>
      ...
      $obj_pdf->Output('Currently_Present_detail.pdf', 'I');
 }
 ?>
 <?php session_start();?>
 <!DOCTYPE html>
