<?php
 function fetch_data()
 {
      ...
      $sql="SELECT * FROM user where Department='$dept' and role='student' order by Name";
      $result=mysqli_query($conn,$sql);
      while($row=mysqli_fetch_array($result)){
        ...
        $Email = $row['Email'];
        $sql = "SELECT * FROM librarydata WHERE ID='$id' AND Enrty_Time  > DATE_SUB(CURDATE(), INTERVAL 1 DAY) order by Enrty_Time";
 ...
 if(isset($_POST["create_pdf"]))
 {
      ...
      $obj_pdf->SetTitle("Today_Login_detail");
      ...
      $content .= '
      <h3 align="center"><BR>
Library Attendance Register Log<br><br><br><br>
      ...
      $obj_pdf->Output('Today_Login_detail.pdf', 'I');
 }
 ?>
 <?php session_start();?>
 <!DOCTYPE html>
