...
if(isset($_POST['submit']))
{
    ...
    $ph_no = $_POST['phn_no'];
    $email = $_POST['email'];
	$result = "INSERT INTO `user`VALUES ('','$rfid','$name','$batch','$course','$dept','$ph_no','$email','$name','$name','student')";
              ...
              <div class="signup-content">
                <form method="POST" id="signup-form" class="signup-form">
                  ...
                  <div class="form-group">
                      <input type="text" class="form-input" name="rfid" id="rfid" placeholder="Your Rfid" required/>
                  </div>
                  ...
                  <div class="form-group">
                      <input type="text" class="form-input" name="batch" id="batch" placeholder="Batch" required/>
                  </div>

                  <div class="form-group">
                      <input type="text" class="form-input" name="course" id="course" placeholder="Course" required/>
                  </div>
